...
const EQUALS_BUTTON = document.querySelector('.btn-equal');
const CLEAR_BUTTON = document.querySelector('.btn-clear');
const DELETE_BUTTON = document.querySelector('.btn-delete');
const FIRST_OPERATION_SCREEN = document.querySelector('.calc-display-firstTerm');
const SECOND_OPERATION_SCREEN = document.querySelector('.calc-display-secondTerm');
